...
let SRC_FRONTEND_INTERNAL =
      "${simpleInternal.hostname}:${Natural/show
                                      Simple/Frontend.Containers.frontendInternal.ports.http-internal}"

in  { networks.sourcegraph = None <>
    , services =
      { caddy =
      ...
      , precise-code-intel-bundle-manager =
        ...
        , healthcheck =
          ...
          , start_period = "60s"
          , test =
              "wget -q 'http://127.0.0.1:3187/healthz' -O /dev/null || exit 1"
          , timeout = "5s"
          }
        , image =
      ...
      , precise-code-intel-worker =
        ...
        , healthcheck =
          ...
          , start_period = "60s"
          , test =
              "wget -q 'http://127.0.0.1:3188/healthz' -O /dev/null || exit 1"
          , timeout = "5s"
          }
        , image =
      ...
      , searcher-0 =
        ...
        , healthcheck =
          ...
          , retries = 3
          , test =
              "wget -q 'http://127.0.0.1:3181/healthz' -O /dev/null || exit 1"
          , timeout = "10s"
          }
        , image =
      ...
      , symbols-0 =
        ...
        , healthcheck =
          ...
          , start_period = "60s"
          , test =
              "wget -q 'http://127.0.0.1:3184/healthz' -O /dev/null || exit 1"
          , timeout = "5s"
          }
        , image =
      ...
      , syntect-server =
        ...
        , healthcheck =
          ...
          , start_period = "5s"
          , test =
              "wget -q 'http://127.0.0.1:9238/health' -O /dev/null || exit 1"
          , timeout = "5s"
          }
        , image =
      ...
      , zoekt-webserver-0 =
        ...
        , healthcheck =
          ...
          , retries = 3
          , test =
              "wget -q 'http://127.0.0.1:6070/healthz' -O /dev/null || exit 1"
          , timeout = "10s"
          }
