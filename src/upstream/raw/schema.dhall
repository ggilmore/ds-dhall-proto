    ...
    , Cadvisor :
        ...
        , ClusterRoleBinding :
            { cadvisor :
                ...
                , subjects : List { kind : Text, name : Text, namespace : Text }
                }
            }
        , DaemonSet :
            { cadvisor :
                ...
                , spec :
                    ...
                    , template :
                        ...
                        , spec :
                            ...
                            , volumes :
                                List { hostPath : { path : Text }, name : Text }
                            }
                        }
                    }
                }
    ...
    , Frontend :
                        ...
                        , spec :
                            { containers :
                                List
                                  ...
                                  , volumeMounts :
                                      Optional
                                        (List { mountPath : Text, name : Text })
                                  }
                            , securityContext : { runAsUser : Natural }
                            , serviceAccountName : Text
                            , volumes : List { emptyDir : {}, name : Text }
                            }
                        }
                    }
                }
        ...
        , RoleBinding :
            { sourcegraph-frontend :
                ...
                , roleRef : { apiGroup : Text, kind : Text, name : Text }
                , subjects : List { kind : Text, name : Text }
                }
            }
        , Service :
            { sourcegraph-frontend :
                ...
                , spec :
                    { ports :
                        List { name : Text, port : Natural, targetPort : Text }
                    , selector : { app : Text }
                    , type : Text
                    }
                }
        ...
        , ServiceAccount :
            { sourcegraph-frontend :
                { apiVersion : Text
                , imagePullSecrets : List { name : Text }
                , kind : Text
                , metadata :
                    { labels :
                        { `app.kubernetes.io/component` : Text
            ...
            { pgsql :
                ...
                , spec :
                    ...
                    , template :
                        { metadata :
                            { labels :
                                { app : Text, deploy : Text, group : Text }
                            }
                        , spec :
                            { containers :
                                List
